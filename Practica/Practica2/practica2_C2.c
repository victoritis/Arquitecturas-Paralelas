...
int main (int argc,char *argv[]){
  ...
  int MR[n];
	...
	if (mirango == 0){
		printf("En este programa el proceso 0 no realiza ningun calculo de suma de filas de matrices\n El proceso 0 solamente generara las dos matrices, se las pasara a los otros procesos y recopilara la matriz resultado\n\n");
